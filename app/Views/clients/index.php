                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <button @click="editClient(<?= htmlspecialchars(json_encode($client)) ?>)" class="text-primary-600 hover:text-primary-700" title="Modifier" <?php if (!can('clients.update')): ?>style="display:none"<?php endif; ?>>
