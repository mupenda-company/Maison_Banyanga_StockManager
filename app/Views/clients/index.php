    ...
    <div class="card">
        <div class="card-header flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
            ...
            <form method="get" class="grid w-full min-w-0 grid-cols-1 sm:grid-cols-2 xl:flex xl:w-auto xl:items-center gap-3">
                ...
                <?php if (is_owner()): ?><a href="<?= url('clients/qr?' . http_build_query(array_diff_key($_GET, ['page' => true, 'per_page' => true]))) ?>" target="_blank" class="btn btn-secondary w-full xl:w-auto">QR clients filtrés</a><?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <?php if (is_owner()): ?>
                                        <a href="<?= url('clients/' . $client['id'] . '/qr') ?>" target="_blank" class="text-purple-600 hover:text-purple-800" title="Imprimer le QR code">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h6v6H3V3zm12 0h6v6h-6V3zM3 15h6v6H3v-6zm12 0h2v2h-2v-2zm4 0h2v6h-2v-6zm-4 4h2v2h-2v-2z"/></svg>
                                        </a>
                                        <?php endif; ?>
