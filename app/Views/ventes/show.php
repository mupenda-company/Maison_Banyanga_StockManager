        ...
        <div class="card">
            <div class="card-header flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?= url('ventes/' . $vente['id'] . '/edit') ?>" class="btn btn-sm btn-primary">
                        Modifier
                    </a>
                    <?php endif; ?>
                    <?php if (can('ventes.imprimer')): ?><a href="<?= url('ventes/' . $vente['id'] . '/print') ?>" target="_blank" class="btn btn-sm btn-secondary">
