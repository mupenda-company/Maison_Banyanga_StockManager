                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-2">
                                ...
                                <?php if ($vente['statut'] === 'validee' && can('ventes.modifier')): ?>
                                <a href="<?= url('ventes/' . $vente['id'] . '/edit') ?>" class="text-blue-600 hover:text-blue-700" title="Modifier">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if (can('ventes.imprimer')): ?><a href="<?= url('ventes/' . $vente['id'] . '/print') ?>" target="_blank" class="text-gray-600 hover:text-gray-700" title="Imprimer">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
