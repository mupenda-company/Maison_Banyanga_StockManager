...
$routes = [
    ...
    'GET::/emballages/emprunts/(\d+)/print' => ['EmpruntEmballageController', 'printBon'],
    'GET::/emballages/emprunts/remboursements/(\d+)/print' => ['EmpruntEmballageController', 'printRemboursement'],
    ...
    'GET::/admin/objectifs/print' => ['AdminController', 'printObjectifs'],
    'GET::/admin/objectifs/export' => ['AdminController', 'exportObjectifs'],
